 ...
 * 16进制编码
 */
public class PrefixedStringSb16CodecFactory implements ProtocolCodecFactory {
    private String encoding = "UTF-8";
    private boolean lenthIncludeSelf = true;

    private final PrefixedStringSb16Encoder encoder;

    private final PrefixedStringSb16Decoder decoder;

    public PrefixedStringSb16CodecFactory() {
        encoder = new PrefixedStringSb16Encoder();
        encoder.setEncoding(encoding);
        decoder = new PrefixedStringSb16Decoder();
